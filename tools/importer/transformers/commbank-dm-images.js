...
/**
 * Transformer: CommBank Dynamic Media / Scene7 image rewriting.
 * Converts DM <img> tags into anchors that survive markdown round-trips.
 * The companion auto-block in scripts/scripts.js rebuilds responsive <picture>
 * elements from these anchors at render time.
 *
 * Detected DM domain: assets.commbank.com.au (vanity CNAME to Scene7)
 * Example URL: https://assets.commbank.com.au/is/image/commbank/...
 *
 * Runs in afterTransform only — block parsers need <img> to build their cells
